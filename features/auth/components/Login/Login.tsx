...
function OrbitLogo({ size = 36 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <ellipse cx="12" cy="12" rx="10" ry="4.6" stroke="var(--accent)" strokeWidth="1.7" transform="rotate(-28 12 12)" opacity=".85" />
  ...
  return (
    <div className={styles.root}>
      <div className={styles.card}>
        ...
        <Input variant="text" label={t.placeholders.email} placeholder="you@company.com" />
        <Input variant="password" label={t.placeholders.password} placeholder="••••••••" />
